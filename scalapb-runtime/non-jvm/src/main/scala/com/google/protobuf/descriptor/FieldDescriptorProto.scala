...
final class FieldDescriptorProto(
    ...
    override def toString(): _root_.scala.Predef.String = s"FieldDescriptorProto(${name}, ${number}, ${label}, ${`type`}, ${typeName}, ${extendee}, ${defaultValue}, ${oneofIndex}, ${jsonName}, ${options}, ${unknownFields})"
    def copy(
